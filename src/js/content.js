const allData = [
  ...
  [`Set status`, `设置状态`],
  [`Edit status`, `编辑状态`],
  [`What's happening`, `你此刻在干嘛？`],
  [`characters remaining`, `个字符剩余`],
  [`Busy`, `忙`],
  [`When others mention you, assign you, or request your review, GitHub will let them know that you have limited availability.`,
    `当其他人提到你、分配给你或请求你的审查时，GitHub 会让他们知道你很忙。`,],
  [`Expiration`, `过期时间`],
  [`Your status will be cleared after the selected time.`, `你的状态将在选定的时间后被清除。`],
  [`Visible to`, `可见范围`],
  [`Limit status visibility to a single organization.`, `仅限某个组织的成员查看我的状态`],
  [`Clear status`, `清除状态`],
  [`Set status`, `设置状态`],
  [`Everyone`, `所有人`],
  [`Never`, `从不`],
  ...
  [`In 4 hours`, `4小时后`],
  [`After today`, `今天之后`],
  [`After this weekend`, `本周末之后`],
  [`After a month`, `一个月后`],
  [`On vacation`, `休假中`],
  [`Out sick`, `生病中`],
  [`Working from home`, `在家工作`],
  [`Focusing`, `专注中`],
  [`You don’t have any gists yet.`, `你还没有任何代码片段。`],
  [`Your public gists will show up here on your profile.`, `你的公开代码片段会显示在个人主页的此处。`],
  [`View GitHub Profile`, `查看 GitHub 个人资料`],
  [`All gists`, `所有代码片段`],
  [`Back to Github`, `返回 Github`],
  [`Latest from our changelog`, `我们更新日志的最新内容`],
  [``, ``],
  [``, ``],
  [``, ``],
  [``, ``],
